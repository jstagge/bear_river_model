...
data_path <- file.path(data_path,"usgs_storage_data")

### Set global output location
output_path <- file.path(output_path,"usgs_storage_data")
...
## Read in sites
###########################################################################
site <- readNWISdata(bBox=c(-113,41,-110,43), parameterCd=param_cd,
